...
Projectile.prototype.move = function(Zeus) {
  ...
  var xVel = cannonBarrel.anglex - cannonBarrel.x - 5;
  var yVel = cannonBarrel.angley - cannonBarrel.y - 5;
  var g = powerSetting(Zeus.toggle.y);
  projectileMovement(x, y, xVel, yVel, g, Zeus);
  return this;
};
...
var projectileMovement = function(x, y, xVel, yVel, g, Zeus) {
